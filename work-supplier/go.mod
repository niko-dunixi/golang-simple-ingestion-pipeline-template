module github.com/niko-dunixi/golang-simple-ingestion-pipeline-template/work-supplier
...
require (
	...
	github.com/niko-dunixi/golang-simple-ingestion-pipeline-template/lib v0.0.0-20230909042806-cd05c7309279
